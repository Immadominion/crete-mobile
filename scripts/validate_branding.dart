...
class BrandingValidator {
  static const String workingDirectory = '/Users/immadominion/codes/projects/crete';
  ...
  static bool validateSplashConfiguration() {
    ...
    final requiredConfigs = [
      ...
      'color: "#FFFFFF"',
      'image: "assets/icons/transparent/appstore.png"',
      'color_dark: "#000000"',
  ...
  static bool validateAppMetadata() {
    ...
    final androidManifest = File('$workingDirectory/android/app/src/main/AndroidManifest.xml');
    ...
    final androidStrings = File('$workingDirectory/android/app/src/main/res/values/strings.xml');
    ...
    if (!androidStringsContent.contains('<string name="app_name">Crete</string>')) {
  ...
  static bool validateCurrentTheme() {
    try {
      final result = Process.runSync(
        'dart',
        ['scripts/icon_manager.dart', 'current'],

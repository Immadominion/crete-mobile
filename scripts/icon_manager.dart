...
class IconManager {
  ...
  static const Map<String, String> availableThemes = {
    'transparent': 'assets/icons/transparent/appstore.png',
...
''');
  ...
  static void showCurrentTheme() {
    ...
    for (int i = 0; i < lines.length; i++) {
      ...
      if (inIconConfig && line.isNotEmpty && !line.startsWith('  ') && !line.startsWith('\t')) {
        break;
      }
    }
    ...
    if (currentImagePath != null) {
      final currentTheme = availableThemes.entries
          .firstWhere((entry) => entry.value == currentImagePath,
